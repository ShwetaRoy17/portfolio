...
export const heroStats = [
  { icon: "⚙️", value: "Backend", label: "Primary Focus" },
  { icon: "🚀", value: "1M+", label: "Users Supported" },
  { icon: "🧠", value: "Elsevier", label: "Research Publication" },
  { icon: "🟢", value: "Open", label: "To Opportunities" }
];
  ...
  traits: [
    {
      ...
      description: "Designing APIs, services, and backend platforms with a focus on performance, maintainability, and scale."
    },
    {
      icon: "⚡",
      title: "Concurrency & Systems",
      description: "Strong understanding of multithreading, process management, goroutines, channels, and low-latency systems."
    },
    {
      icon: "🎥",
      title: "Real-Time Systems",
      description: "Experience with streaming pipelines, FFmpeg workflows, adaptive bitrate logic, and distributed real-time processing."
    },
    {
      icon: "🧠",
      title: "Research Depth",
      description: "Hands-on work in federated learning, time-series forecasting, GAN-CNN-LSTM models, and applied ML systems."
    }
  ]
};
